...
const ProductItem=({product})=>{
    ...
    return (<div>
        <div className="group relative">
          <div className="aspect-h-1 aspect-w-1   rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
            <img
        ...
        {count==0 ? 
        <div className="justify-between items-center text-gray-900">
          <button
            className="py-1  uppercase rounded-full min-w-full mt-3
...
export default function AppHomeItems() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
          {products.map((product, k) => (
            <ProductItem key={k} product={product}/>
          ))}
        </div>
      </div>
    </div>
